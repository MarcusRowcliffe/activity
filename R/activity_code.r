...
#'  @slot bs Object of class \code{"matrix"} holding bootstrap realisations of circular kernel PDF values (time points in the rows as in pdf, replicates in the columns).
